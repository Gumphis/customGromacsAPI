...
tsResult SkipLine(FILE* file) { return GetWord(NULL, file, "\n", "", "", 0); }
tsResult GetWordWithLength(char* word, int number, FILE* file) { return GetWord(word, file, " \n\t", " \n\t", "", number); }
tsResult GetLine(char* word, FILE* file) { return GetWord(word, file, "\n", "", "", 0); }
tsResult SkipCharacters(int number, FILE* file) { return GetWord(NULL, file, "", "", "", number); }
float GetFloatWithLength(int number, FILE* file) { return GetFloat(file, " \n\t", " \n\t", "", number); }
int GetIntWithLength(int number, FILE* file) { return GetInt(file, " \n\t", " \n\t", "", number); }
double GetDoubleWithLength(int number, FILE* file) { return GetDouble(file, " \n\t", " \n\t", "", number); }

tsResult GetWordWithLength(char* word, int number, const char* inWord, int* iStart) { return GetWord(word, inWord, iStart, " \n\t", " \n\t", "", number); }
tsResult SkipCharacters(int number, const char* inWord, int* iStart) { return GetWord(NULL, inWord, iStart, "", "", "", number); }
float GetFloatWithLength(int number, const char* inWord, int* iStart) { return GetFloat(inWord, iStart, " \n\t", " \n\t", "", number); }
int GetIntWithLength(int number, const char* inWord, int* iStart) { return GetInt(inWord, iStart, " \n\t", " \n\t", "", number); }
double GetDoubleWithLength(int number, const char* inWord, int* iStart) { return GetDouble(inWord, iStart, " \n\t", " \n\t", "", number); }
